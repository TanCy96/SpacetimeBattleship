    ...
    public sealed class DbConnection : DbConnectionBase<DbConnection, RemoteTables, Reducer>
    {
        ...
        protected override Reducer ToReducer(TransactionUpdate update)
        {
            ...
            return update.ReducerCall.ReducerName switch
            {
                ...
                "CreateGame" => BSATNHelpers.Decode<Reducer.CreateGame>(encodedArgs),
                "Disconnect" => BSATNHelpers.Decode<Reducer.Disconnect>(encodedArgs),
                "FireAt" => BSATNHelpers.Decode<Reducer.FireAt>(encodedArgs),
                "PlaceShip" => BSATNHelpers.Decode<Reducer.PlaceShip>(encodedArgs),
        ...
        protected override bool Dispatch(IReducerEventContext context, Reducer reducer)
        {
            ...
            return reducer switch
            {
                ...
                Reducer.FireAt args => Reducers.InvokeFireAt(eventContext, args),
                Reducer.PlaceShip args => Reducers.InvokePlaceShip(eventContext, args),
